...
El lenguaje de programacion con la sintaxis mas facil de comprender es python ya que tiene una simplicidad bastante significativa en 	codigo extensos y de programacion especifica que se denota en el nombre de sus metodos y funciones implementados. 
...
La segunda, pídale a ChatGPT que transforme el código anterior, escrito de forma imperativa, a una versión en donde se utilice el paradigma de programación funcional, para los lenguajes de programación: Haskell, Python y Scala 3. Le sugiero incluir en el prompt el código Java anterior. 

**Codigo funcional Haskell**
```haskell
...
**Codigo funcional funcional Python**
```python
	from functools import reduce
