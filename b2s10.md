...
object SumaReactiva extends App {
  ...
  // Observador
  val observer = derivado.changed.observe { v =>
    println(s"Valor obtenido: $v")
  }
...
```
<img width="959" height="1028" alt="image" src="https://github.com/user-attachments/assets/c0aa0c26-5561-40f3-83e0-8f39bc5afae3" />
...
object EnergiaCinetica extends App{
  ...
  val calculo = Signal[Double]{
    0.5 * masa.value * Math.pow(velocidad.value,2)
  }

  val observer = calculo.observe{ v =>
    println(s"Energia cinetica: $v")
    if(v > 1000000){
...
<img width="959" height="1030" alt="image" src="https://github.com/user-attachments/assets/810e0446-1cca-47ed-aef5-cc0a3c8036c4" />
